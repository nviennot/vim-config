...
hi default ShowMarksHLl ctermbg=236    cterm=bold guibg=#374A4D gui=bold
hi default ShowMarksHLu ctermfg=white  cterm=bold guifg=white gui=bold
hi default ShowMarksHLo ctermfg=white  cterm=bold guifg=white gui=bold
hi default ShowMarksHLm ctermfg=white  cterm=bold guifg=white gui=bold
